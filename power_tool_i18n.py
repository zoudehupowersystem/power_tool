...
# Forecast pages and result text. / 预测类页面与结果文本。
DISPLAY_ZH_TO_EN.update({
    "日前负荷预测": "Day-Ahead Load Forecast",
    "负荷日前预测": "Day-Ahead Load Forecast",
    "新能源预测": "Renewable Forecast",
    "新能源日前预测": "Day-Ahead Renewable Forecast",
    "年度负荷预测": "Annual Load Forecast",
    "负荷日前预测结果": "Day-Ahead Load Forecast Result",
    "新能源日前预测结果": "Day-Ahead Renewable Forecast Result",
    "年度负荷预测结果": "Annual Load Forecast Result",
    "训练数据集": "Training dataset",
    "纬度 / °": "Latitude / deg",
    "经度 / °": "Longitude / deg",
    "海拔 / m（平原可填 0）": "Altitude / m (enter 0 for plains)",
    "预测日期（YYYY-MM-DD）": "Forecast date (YYYY-MM-DD)",
    "节假日国家/地区": "Holiday country/region",
    "时段间隔 / min（1-30）": "Interval / min (1-30)",
    "预测算法": "Forecast algorithm",
    "装机容量上限 / MW": "Installed-capacity limit / MW",
    "新能源类型": "Renewable type",
    "天气场景": "Weather scenario",
    "云量 / %": "Cloud cover / %",
    "辐照人工系数": "Manual irradiance factor",
    "组件倾角 / °": "Panel tilt / deg",
    "组件方位角 / °": "Panel azimuth / deg",
    "地表反照率": "Ground albedo",
    "组件温度系数 %/℃": "Panel temperature coefficient %/degC",
    "预测": "Forecast",
    "导出JSON": "Export JSON",
    "导出CSV": "Export CSV",
    "24/96点明细": "24/96-Point Details",
    "算法与日特性": "Algorithm & Daily Profile",
    "太阳角度/轨迹": "Solar Angle / Path",
    "时间": "Time",
    "预测/MW": "Forecast/MW",
    "温度℃": "Temperature degC",
    "太阳高°": "Solar altitude deg",
    "方位°": "Azimuth deg",
    "入射°": "Incidence deg",
    "天气系数": "Weather factor",
    "PV修正": "PV factor",
    ...
    "雨雪": "Rain / snow",
    "雾霾": "Haze",
    "scikit-learn自动引擎": "scikit-learn Auto Engine",
    "自适应综合方案": "Adaptive ensemble",
    "自适应综合方案（": "Adaptive ensemble (",
    "岭回归": "Ridge regression",
    "Huber鲁棒回归": "Huber robust regression",
    "相似日同刻法": "Analog same-hour method",
    "同刻指数平滑": "Same-slot exponential smoothing",
    "周周期基准": "Weekly-cycle baseline",
    "随机森林": "Random forest",
    "梯度提升树": "Gradient boosting",
    "气候板块": "Climate block",
    "预测年限（5-20）": "Forecast horizon (5-20 years)",
    "预测方法": "Forecast method",
    "综合法": "Comprehensive method",
    "趋势外推法": "Trend extrapolation",
    "弹性系数法": "Elasticity-coefficient method",
    "GDP 年增长 / %": "Annual GDP growth / %",
    "人口年增长 / %": "Annual population growth / %",
    "第一产业增长 / %": "Primary-sector growth / %",
    "第二产业增长 / %": "Secondary-sector growth / %",
    "第三产业增长 / %": "Tertiary-sector growth / %",
    "负荷同时率": "Load coincidence factor",
    "双碳政策修正 / %": "Dual-carbon policy adjustment / %",
    "再电气化修正 / %": "Re-electrification adjustment / %",
    "年度预测": "Annual Forecast",
    "年度趋势": "Annual Trend",
    "分季节典型形态": "Seasonal Typical Profiles",
    "典型形态年份：预测后可拖动选择": "Typical-profile year: run the forecast, then drag to select",
    "春季": "Spring",
    "夏季": "Summer",
    "秋季": "Autumn",
    "冬季": "Winter",
    "高纬寒冷/极地": "High-latitude cold / polar",
    "寒温带大陆": "Cold-temperate continental",
    "美国西海岸/海洋性": "U.S. West Coast / marine",
    "地中海型夏干": "Mediterranean dry-summer",
    "湿润亚热带": "Humid subtropical",
    "干旱荒漠/高日照": "Arid desert / high irradiance",
    "热带": "Tropical",
    "南半球温带": "Southern-hemisphere temperate",
    "南半球寒温带": "Southern-hemisphere cold temperate",
    "副热带/暖温带": "Subtropical / warm temperate",
    "温带": "Temperate",
    "高纬寒冷": "High-latitude cold",
    "华东湿润夏热冬冷气候区": "East China humid hot-summer cold-winter climate zone",
    "假想江南新区年度负荷规划样例": "Fictional Jiangnan New District annual-load planning sample",
    "程序内置假想区域样例（用于无公开完整规划数据时演示）": "Built-in fictional regional sample (for demos when complete public planning data is unavailable)",
    "江南新区": "Jiangnan New District",
    "规划区域": "Planning region",
    "内置年度负荷规划样例": "Built-in annual-load planning sample",
    "尚无结果": "No Result Yet",
    "年度负荷预测错误": "Annual Load Forecast Error",
    "预测失败": "Forecast Failed",
    "太阳角度分析失败": "Solar Angle Analysis Failed",
    "纬度": "Latitude",
    "经度": "Longitude",
    "海拔": "Altitude",
    "装机容量上限": "Installed-capacity limit",
    "时段间隔": "Interval",
    "组件倾角": "Panel tilt",
    "组件方位角": "Panel azimuth",
    "组件温度系数": "Panel temperature coefficient",
    "GDP 年增长": "Annual GDP growth",
    "人口年增长": "Annual population growth",
    "第一产业增长": "Primary-sector growth",
    "第二产业增长": "Secondary-sector growth",
...
PHRASE_ZH_TO_EN.update({
    "面向调度员的日前预测：内置 JSON 已配置算法库、地区模板、节假日和特殊事件；支持 24 点/96 点输出、人工选择算法和综合方案。": "Day-ahead forecasting for dispatchers: the built-in JSON config provides algorithm catalogs, regional templates, holidays, and special events; 24-point and 96-point outputs, manual algorithm selection, and ensemble forecasting are supported.",
    "请选择数据集、算法和时段间隔，然后点击“预测”。": "Select a dataset, algorithm, and interval, then click \"Forecast\".",
    "预测完成后显示算法权重、留出校验误差、峰谷差、负荷率/容量因子等信息。": "After forecasting, algorithm weights, holdout error, peak-valley spread, load factor / capacity factor, and related metrics are shown here.",
    "太阳角度、天气修正 GHI 与组件 POA 将自动联动到新能源预测。可在下方拖拽日照区间滑条，或直接在右侧曲线区拖拽当前时刻。": "Solar angle, weather-corrected GHI, and panel POA are linked automatically to the renewable forecast. Drag the daylight slider below, or drag directly in the curve area to choose the current time.",
    "日照区间生成后，可拖拽滑条；也可在太阳高度曲线区域拖拽选择当前时刻。": "After the daylight interval is generated, drag the slider or drag in the solar-altitude curve to choose the current time.",
    "面向电网规划的 5–20 年年度电量、最大负荷与分季节典型负荷形态预测；不包含空间负荷预测。": "Forecasts 5-20 years of annual energy, peak load, and seasonal typical load profiles for grid planning; spatial load forecasting is not included.",
    "请填写规划输入后点击“年度预测”。": "Enter the planning inputs, then click \"Annual Forecast\".",
    "请先执行年度预测，再导出结果。": "Run the annual forecast before exporting results.",
    "请先执行预测，再导出结果。": "Run the forecast before exporting results.",
    "年度负荷预测结果已导出：": "Annual load forecast result exported: ",
    "预测结果已导出：": "Forecast result exported: ",
    "时段间隔需为 1 到 30 分钟之间的整数。": "The interval must be an integer between 1 and 30 minutes.",
    "数据集：": "Dataset:",
    "来源：": "Source:",
    "自动气候板块：": "Auto climate block:",
    "算法：": "Algorithm:",
    "提示：新能源预测只对所选风电或光伏资源独立建模。": "Hint: renewable forecasting models only the selected wind or PV resource independently.",
    "可选 scikit-learn 树模型引擎；进入预测时延迟导入，并优先使用梯度提升树/随机森林。": "Optional scikit-learn tree-model engine; imported lazily when forecasting starts, with gradient boosting / random forest preferred.",
    "对候选算法做留出校验，按误差反比自动分配权重，输出综合曲线。": "Validates candidate algorithms on a holdout set, assigns weights inversely to error, and outputs the ensemble curve.",
    "对候选算法做滚动留出校验，按误差反比自动分配权重，形成综合预测方案。": "Validates candidate algorithms with rolling holdout checks and assigns inverse-error weights to form the ensemble forecast.",
    "线性可解释模型，包含小时、星期、节假日、季节、气象和地理特征。": "Linear interpretable model using hour, weekday, holiday, season, weather, and geographic features.",
    "对坏点、尖峰点更稳健；使用两阶段 Huber 权重岭回归，作为鲁棒基线。": "More robust to bad points and spikes; uses two-stage Huber-weighted ridge regression as a robust baseline.",
    "对异常点更稳健；使用两阶段 Huber 权重岭回归，作为鲁棒基线。": "More robust to outliers; uses two-stage Huber-weighted ridge regression as a robust baseline.",
    "按同小时、日型、节假日和气象相似度选取历史样本，适合调度员经验校核和节假日对比。": "Selects historical samples by same hour, day type, holiday, and weather similarity; suitable for operator experience checks and holiday comparisons.",
    "按同小时、日型、节假日和气象相似度选取历史样本，适合人工经验校核。": "Selects historical samples by same hour, day type, holiday, and weather similarity; suitable for manual experience checks.",
    "按同一时刻历史值进行递近加权，偏重近期走势，可作为负荷还原修正后的快速基准。": "Applies recursive weighting to historical values at the same time slot, emphasizing recent trends; useful as a quick baseline after load-restoration correction.",
    "对同一时刻的历史值做递近加权，偏重近期负荷或出力规律。": "Recursively weights historical values at the same time slot, emphasizing recent load or output patterns.",
    "优先取上一周同刻值，缺失时退化为前一日或同刻中位数。": "Uses the same time slot from the previous week first, falling back to the previous day or same-slot median when missing.",
    "优先使用上一周同刻值，缺失时使用前一日或同刻中位数，作为保底预测。": "Uses the same time slot from the previous week first, then the previous day or same-slot median as a fallback baseline.",
    "可选 scikit-learn 非线性树模型，适合气象非线性较强场景；进入预测时延迟导入。": "Optional scikit-learn nonlinear tree model for stronger weather nonlinearity; imported lazily when forecasting starts.",
    "可选 scikit-learn 提升树模型，适合小样本非线性拟合对比；进入预测时延迟导入。": "Optional scikit-learn boosting tree model for small-sample nonlinear fitting comparisons; imported lazily when forecasting starts.",
    "已选择外部训练 CSV。支持 timestamp/load_mw/demand_mw/solar_mw/wind_mw/renewable_mw/temperature_c/ghi_wm2/wind_speed_mps，以及中文 日期/时刻/统调负荷/气温、Baidu KDD Tmstamp/Wspd/Patv 等表头。": "External training CSV selected. Supported headers include timestamp/load_mw/demand_mw/solar_mw/wind_mw/renewable_mw/temperature_c/ghi_wm2/wind_speed_mps, Chinese date/time/dispatch-load/temperature columns, and Baidu KDD Tmstamp/Wspd/Patv fields.",
    "已选择未来天气 CSV：": "Future weather CSV selected: ",
    "记录数：": "Records: ",
    "时间范围：": "time range: ",
    "字段：": "fields: ",
    "预测时同时间戳温度/GHI/风速/云量将优先覆盖或修正历史同刻推断值；小时级天气会对 1–30 分钟预测点插值。": "During forecasting, same-timestamp temperature/GHI/wind speed/cloud cover override or adjust historical same-slot estimates first; hourly weather is interpolated onto 1-30 minute forecast points.",
    "══ 负荷日前": "══ Day-Ahead Load",
    "══ 新能源日前": "══ Day-Ahead Renewable",
    "点预测": "point forecast",
    "模型：": "Model: ",
    "气候板块：": "Climate block: ",
    "留出校验/残差 MAE：": "Holdout / residual MAE: ",
    "峰值：": "Peak: ",
    "谷值：": "Valley: ",
    "峰谷差：": "Peak-valley spread: ",
    "负荷率/容量因子：": "Load factor / capacity factor: ",
    "日电量/发电量：": "Daily energy / generation: ",
    "── 算法校验与权重 ─────────────────────────────": "-- Algorithm Validation & Weights ----------------------------",
    "══ 算法校验与日特性 ══════════════════════": "══ Algorithm Validation & Daily Characteristics ══════════════",
    "算法                     权重      MAE/MW    RMSE/MW   MAPE/%   状态": "Algorithm                 Weight    MAE/MW    RMSE/MW   MAPE/%   Status",
    "小时                  P10      预测      P90      调度提示": "Time                  P10      Forecast      P90      Dispatch hints",
    "── 日特性摘要 ───────────────────────────────": "-- Daily Characteristic Summary ------------------------------",
    "日特性：": "Daily characteristics:",
    "最终模型：": "Final model: ",
    "默认 scikit-learn 引擎：": "Default scikit-learn engine: ",
    "scikit-learn 树模型调用失败：": "scikit-learn tree model call failed: ",
    "scikit-learn 自动引擎未能完成梯度提升树或随机森林训练。": "The scikit-learn auto engine could not complete gradient-boosting or random-forest training.",
    "两阶段Huber权重岭回归。": "Two-stage Huber-weighted ridge regression.",
    "综合预测方案": "Ensemble forecast",
    "训练样本为空。": "The training sample is empty.",
    "不可用，已回退为岭回归": "unavailable; fell back to ridge regression",
    "未知算法 ": "Unknown algorithm ",
    " 已按岭回归执行。": " was executed as ridge regression.",
    "算法 ": "Algorithm ",
    " 不支持 ": " does not support ",
    "峰值MW": "Peak MW",
    "谷值MW": "Valley MW",
    "峰谷差MW": "Peak-valley spread MW",
    "平均MW": "Average MW",
    "最大上爬坡MW/点": "Maximum upward ramp MW/point",
    "最大下爬坡MW/点": "Maximum downward ramp MW/point",
    "日电量/发电量MWh": "Daily energy / generation MWh",
    "装机利用率": "Installed-capacity utilization",
    "负荷率/容量因子": "Load factor / capacity factor",
    "工作日": "workday",
    "周末": "weekend",
    "节假日": "holiday",
    ...
    "资源=光伏": "resource=PV",
    "资源=风电": "resource=wind",
    "未来天气=CSV": "future weather=CSV",
    "太阳高=": "solar altitude=",
    "方位=": "azimuth=",
    "W/m2，风=": "W/m2, wind=",
    "，资源=": ", resource=",
    "，光伏修正=": ", PV correction=",
    "，事件修正=": ", event adjustment=",
    "入射角=": "incidence angle=",
    "天气系数=": "weather factor=",
    "默认引擎为自适应综合方案；scikit-learn 树模型作为可选算法在进入预测时延迟导入。": "The default engine is the adaptive ensemble; scikit-learn tree models are optional and imported lazily when forecasting starts.",
    "算法可由用户选择；自适应综合方案会对候选模型做留出校验，并按误差反比分配权重。": "The algorithm can be selected by the user; the adaptive ensemble validates candidate models on a holdout set and assigns weights inversely to error.",
    "特征已包含小时、星期、节假日、南北半球季节项、经纬度、海拔、太阳高度角、太阳方位角、组件倾斜面辐照度 POA 和气候板块。": "Features include hour, weekday, holidays, northern/southern hemisphere season terms, latitude, longitude, altitude, solar altitude, solar azimuth, panel-plane irradiance POA, and climate block.",
    "缺失气象数据时会优先使用历史同小时/同刻气候值，并用经纬度、海拔和气候板块估算温度/GHI/风速；若导入未来天气 CSV，则同时间戳温度、GHI、风速会优先覆盖历史推断值。": "When weather data is missing, historical same-hour/same-slot climate values are used first, with temperature/GHI/wind speed estimated from location, altitude, and climate block; when a future-weather CSV is imported, same-timestamp temperature, GHI, and wind speed override historical estimates first.",
    "新能源预测仅支持风电与光伏两类独立资源；光伏资源已联动太阳位置、天气修正、组件倾角/方位角、POA 辐照度和组件温度系数，夜间仍强制清零。": "Renewable forecasting supports only independent wind and PV resources; PV is linked to solar position, weather correction, panel tilt/azimuth, POA irradiance, and panel temperature coefficient, with nighttime output forced to zero.",
    "节假日内置中国和美国；其它国家/地区可通过 data/forecast_holidays.json 或 ForecastConfig.holiday_config_path 扩展。": "Built-in holiday calendars include China and the United States; other countries/regions can be added through data/forecast_holidays.json or ForecastConfig.holiday_config_path.",
    "未来天气预报 CSV 可独立导入；支持 timestamp/date+hour/date+time/date+时刻 与 temperature_c、ghi_wm2、wind_speed_mps、cloud_cover_pct 等字段，预测点与天气时间粒度不一致时会自动插值。": "Future-weather forecast CSV files can be imported independently. Supported fields include timestamp/date+hour/date+time/date+slot plus temperature_c, ghi_wm2, wind_speed_mps, and cloud_cover_pct; weather is interpolated automatically when its time step differs from the forecast grid.",
    "未来天气预报 CSV 可独立导入；支持 timestamp/date+hour/date+time/date+时刻 与 temperature_c、ghi_wm2、wind_speed_mps、cloud_cover_pct 等字段，小时级天气会对高分辨率预测点线性插值。": "Future-weather forecast CSV files can be imported independently. Supported fields include timestamp/date+hour/date+time/date+slot plus temperature_c, ghi_wm2, wind_speed_mps, and cloud_cover_pct; hourly weather is linearly interpolated onto high-resolution forecast points.",
    "1–30 分钟时间颗粒度均支持；高分辨率输出会基于 30 分钟锚点做线性插值，并进行轻量曲线平滑。": "Time resolutions from 1 to 30 minutes are supported; high-resolution output is linearly interpolated from 30-minute anchors and lightly smoothed.",
    "特殊事件修正可通过 data/forecast_builtin_config.json 开启，支持绝对 MW 和相对比例修正。": "Special-event corrections can be enabled in data/forecast_builtin_config.json and support both absolute MW and relative-ratio adjustments.",
    "可直接导入 CAISO/NYISO/ERCOT/PJM/GEFCom/NREL 风格 CSV；表头会自动映射常见字段，并兼容中文日期/时刻/负荷字段。": "CAISO/NYISO/ERCOT/PJM/GEFCom/NREL-style CSV files can be imported directly; headers are mapped automatically for common fields, including Chinese date/time/load fields.",
    "未来天气 CSV 已导入：": "Future weather CSV imported: ",
    "外部未来天气 CSV": "external future-weather CSV",
    "温度/GHI/风速按时间戳映射到预测网格，时段不一致时采用线性插值，缺失字段仍回退为历史同刻与地理气候估计。": "Temperature/GHI/wind speed are mapped to the forecast grid by timestamp, with linear interpolation when time steps differ; missing fields still fall back to historical same-slot and geographic-climate estimates.",
    "光伏预测中，如果未来天气 CSV 已提供 GHI，则该 GHI 被视为外部天气预报基线，不再叠加界面天气场景系数，避免重复折减。": "For PV forecasts, if the future-weather CSV provides GHI, that GHI is treated as the external weather-forecast baseline and the UI weather-scenario factor is not applied again, avoiding double derating.",
    "年度负荷预测至少需要两年历史电量与最大负荷数据。": "Annual load forecasting requires at least two years of historical energy and peak-load data.",
    "══ 年度负荷预测（规划用） ═════════════════════": "══ Annual Load Forecast (Planning) ═════════════════════",
    "区域：": "Region: ",
    "基准年：": "Base year: ",
    "方法：": "method: ",
    "年份      电量/GWh       P10-P90/GWh       最大负荷/MW       P10-P90/MW     负荷率": "Year      Energy/GWh     P10-P90/GWh       Peak Load/MW      P10-P90/MW     Load Factor",
    "典型负荷形态：右侧曲线展示最终规划年春/夏/秋/冬 24 小时典型日形态。": "Typical load profiles: the curve on the right shows the final planning year's 24-hour typical spring/summer/autumn/winter daily profiles.",
    "样例来源：": "Sample source: ",
    "本功能面向规划，不包含空间负荷预测。": "This function is intended for planning and does not include spatial load forecasting.",
    "趋势外推法：历史 CAGR 与线性趋势折中。": "Trend extrapolation: blends historical CAGR with the linear trend.",
    "弹性系数法：GDP/人口/分产业增长与历史电量弹性联动。": "Elasticity-coefficient method: links GDP, population, and sector growth with historical electricity-demand elasticity.",
    "综合法：趋势外推、弹性系数、双碳与再电气化政策修正加权。": "Comprehensive method: weights trend extrapolation, elasticity coefficients, dual-carbon adjustment, and re-electrification policy adjustment.",
    "输入考虑历史负荷、经纬度/气候板块、GDP/人口及分产业增长、负荷同时率、双碳目标与再电气化政策。": "Inputs include historical load, location/climate block, GDP/population and sector growth, load coincidence factor, dual-carbon targets, and re-electrification policy.",
    "P10/P90 为规划不确定性带，年限越远区间越宽；结果宜结合用户报装、产业项目清单和地方能源规划校核。": "P10/P90 represent planning uncertainty bands; the farther the horizon, the wider the interval. Results should be checked against user connection applications, industrial project lists, and local energy plans.",
    "典型形态年份：": "Typical-profile year: ",
    "年分季节典型负荷形态": "seasonal typical load profile",
    "年度用电量预测": "Annual Energy Forecast",
    "用电量/GWh": "Energy/GWh",
    "年度最大负荷预测": "Annual Peak Load Forecast",
    "最大负荷/MW": "Peak Load/MW",
    "负荷日前预测": "Day-Ahead Load Forecast",
    "新能源日前预测（联动太阳几何/天气/POA）": "Day-Ahead Renewable Forecast (linked solar geometry / weather / POA)",
    "预测负荷 / MW": "Forecast load / MW",
    "预测新能源出力 / MW": "Forecast renewable output / MW",
    "日照区间：": "Daylight interval: ",
    "拖拽滑条或曲线区选择当前时刻。": "drag the slider or curve area to choose the current time.",
    "当天无常规日出/日落区间；滑条按 00:00—24:00 显示。": "No regular sunrise/sunset interval for this day; the slider displays 00:00-24:00.",
    "══ 太阳角度与光伏修正辅助分析 ═══════════════": "══ Solar Angle and PV Correction Helper ═══════════════",
    "位置：纬度 ": "Location: latitude ",
    "经度 ": "longitude ",
    "自动采用标准时区 ": "using standard time zone ",
    "标准经线 ": "standard meridian ",
    "分析时刻：": "Analysis time: ",
    "标准时": "standard time",
    "对应太阳时 ": "corresponding solar time ",
    "当前太阳高度角：": "Current solar altitude: ",
    "天顶角：": "zenith angle: ",
    "方位角：": "azimuth: ",
    "°，方位角=": " deg, azimuth=",
    " 小时、": " hours, ",
    " 分钟。": " minutes.",
    "晴空水平 GHI：": "Clear-sky horizontal GHI: ",
    "天气修正后 GHI：": "Weather-corrected GHI: ",
    "倾斜面 POA：": "Plane-of-array POA: ",
    "直射水平：": "Direct horizontal: ",
    "散射水平：": "Diffuse horizontal: ",
    "入射角：": "Incidence angle: ",
    "天气：": "Weather: ",
    "云量=": "cloud cover=",
    "辐照人工系数=": "manual irradiance factor=",
    ...
    "相对功率修正=": "relative power correction=",
    "太阳赤纬：": "Solar declination: ",
    "时差方程：": "equation of time: ",
    "时角：": "hour angle: ",
    "状态：": "status: ",
    "太阳位于地平线上方": "Sun above the horizon",
    "太阳位于地平线以下": "Sun below the horizon",
    "当日太阳轨迹摘要：": "Daily solar-path summary:",
    "日出：": "Sunrise: ",
    "太阳正午：": "Solar noon: ",
    "日落：": "Sunset: ",
    "正午太阳高度角：": "Noon solar altitude: ",
    "白昼长度：": "daylight length: ",
    "说明：方位角采用 0°=正北、90°=正东、180°=正南、270°=正西；可在下方滑条或右侧曲线区拖拽当前时刻，POA 已用于新能源预测。": "Note: azimuth uses 0 deg = north, 90 deg = east, 180 deg = south, and 270 deg = west. Drag the slider below or the curve area on the right to choose the current time; POA is already used in the renewable forecast.",
    "正北": "N",
    "东北偏北": "NNE",
    "东北偏东": "ENE",
    "正东": "E",
    ...
    "南": "S",
    "西": "W",
    "太阳穹顶轨迹图\n（中心=天顶，外圈=地平线）": "Solar dome path\n(center=zenith, outer ring=horizon)",
    "高度角 / °": "Altitude / deg",
    "标准时 / h": "Standard time / h",
    "太阳高度角 / °": "Solar altitude / deg",
    "晴空 GHI / W/m2": "Clear-sky GHI / W/m2",
    "天气修正 GHI / W/m2": "Weather-corrected GHI / W/m2",
    "组件 POA / W/m2": "Panel POA / W/m2",
    "辐照度 / W/m2": "Irradiance / W/m2",
    "正午": "Noon",
    "当前": "Current",
    "全天太阳高度、天气修正 GHI 与组件 POA": "daily solar altitude, weather-corrected GHI, and panel POA",
    "内置数据集": "built-in dataset",
})
...
for _forecast_compass_key in (
    "正北", "东北偏北", "东北", "东北偏东", "正东", "东南偏东", "东南", "东南偏南",
    "正南", "西南偏南", "西南", "西南偏西", "正西", "西北偏西", "西北", "西北偏北",
    "北", "东", "南", "西",
):
    PHRASE_ZH_TO_EN.pop(_forecast_compass_key, None)
